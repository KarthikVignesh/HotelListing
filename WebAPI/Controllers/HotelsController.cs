...
namespace HotelListing.Controllers
{
    ...
    public class HotelsController : ControllerBase
    {
        ...
        {
          new Hotel{Id = 1,  Name = "Grand Plaza" , Address="123 main street" , Rating = 3.5},
          new Hotel{Id = 2,  Name = "Ocean View" , Address="456 beach avenue" , Rating = 4.0}
        };
        ...
        public ActionResult<Hotel> Post([FromBody] Hotel newHotel)
        {
            ...
            {
                return BadRequest("The Hotel already exists");
            }
            hotels.Add(newHotel);
